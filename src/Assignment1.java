...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        //Gets whiteSpaceCount
        String inputValue = JOptionPane.showInputDialog(null, "Please input a value", "Average", JOptionPane.INFORMATION_MESSAGE);
        if (inputValue != null) {JOptionPane.showMessageDialog(null,"There are " +whiteSpaceCount(inputValue)+" white spaces");}
    ...
    public static void reverseInput() {
        String inputValue = JOptionPane.showInputDialog(null, "Enter a your First and Last name Seperated with a space(Ex. John Smith)", "Reverse", JOptionPane.INFORMATION_MESSAGE);
        if (inputValue != null) {JOptionPane.showMessageDialog(null, reverse(inputValue));
        }
    ...
    public static String reverse(String input) {
        char[] in = input.toCharArray();//converting string to array
        int count = 0;
        ...
        while (end > count) {
            ...
            count++; //add 1 so you can move ot the nxt letter from the left
            // keeps going until you get to the middle
        }

        return new String(in); // returns string
    }//Returns reversed string, give string input

    public static int whiteSpaceCount(String input) {
